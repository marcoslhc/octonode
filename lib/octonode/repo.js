...
(function() {
  ...
  Repo = (function() {
    ...
    Repo.prototype.deployments = function() {
      return this.client.get("/repos/" + this.name + "/deployments", function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
          return cb(new Error("Deployment error"));
        } else {
          return cb(null, b, h);
        }
      });
    ...
    Repo.prototype.deployment = function() {
      var cb, i, params, ref1;
      params = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), cb = arguments[i++];
      return (ref1 = this.client).post.apply(ref1, ["/repos/" + this.name + "/deployments"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
    ...
    Repo.prototype.deploymentStatuses = function(id) {
      return this.client.get("/repos/" + this.name + "/deployments/" + id + "/statuses", function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
          return cb(new Error("Deployment status error"));
        } else {
          return cb(null, b, h);
        }
      });
    ...
    Repo.prototype.deploymentStatus = function() {
      var cb, i, id, params, ref1;
      id = arguments[0], params = 3 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 1, []), cb = arguments[i++];
      return (ref1 = this.client).post.apply(ref1, ["/repos/" + this.name + "/deployments/" + id + "/statuses"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
